...
public class SendEmail2 {
    ...
    public static void sendEmailMagazineLink(String emailTo,String fullUrl) throws MessagingException {
        // Recipient's email ID needs to be mentioned.
        Properties props = new Properties();
        props.put("mail.smtp.host", "smtp.gmail.com");
        props.put("mail.smtp.socketFactory.port", "465");
        ...
        message.setSubject("Sua Revista Está disponível");
        message.setContent("Para acessar sua revista click no link:<br/> <a href='" + fullUrl + "'>Revista First Down</a>", "text/html");
